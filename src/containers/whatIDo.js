...
export function WhatIDo({ children }) {
    ...
    return (
        <section
            className="myServices bg-dark bg-work1Img bg-cover bg-blend-multiply 
                        text-light text-center py-16"
            id="services"
        >
            <h2 className="sectionTitle text-accent relative my-4">
                What I do
            </h2>
            <div
                className={`js-show-on-scroll transform duration-1000 
            ...
            >
                ...
                <button>
                    <a
                        href="#work"
                        className="
                                    rounded inline-block py-2 px-6 bg-accent 
                                    text-dark cursor-pointer text-sm uppercase tracking-widest font-black
